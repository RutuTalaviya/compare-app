...
const blogPosts = [
  ...
  },
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1506501139174-099022df5260?w=600&q=80",
  ...
  {
    id: 4,
    title: "HUAWEI nova 13 series with 120Hz OLED display, 60MP front camera go global",
    imageUrl: "https://images.unsplash.com/photo-1512499617640-c74ae3a79d37?w=600&q=80",
    link: "/blog/huawei-nova-13-series",
  },
  {
    id: 5,
    title: "iPhone 15 review: Why I recommend this model even to 'Pro' users in 2024",
    imageUrl: "https://images.unsplash.com/photo-1695048133142-1a20484d2569?w=600&q=80",
    link: "/blog/iphone-15-review",
  },
  {
    id: 6,
    title: "iPhone 16 Pro vs. iPhone 13 Pro: Should you upgrade to Apple's latest model?",
  ...
  },
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1544425660-2da62df8fc2e?w=600&q=80",
    link: "/blog/fujifilm-acuity-tr",
  },
  {
    id: 8,
    title: "Nothing Phone 4a Pro Review: A Big Leap",
    imageUrl: "https://images.unsplash.com/photo-1616348436168-de43ad0db179?w=600&q=80",
